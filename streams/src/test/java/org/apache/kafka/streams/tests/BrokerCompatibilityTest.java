...
public class BrokerCompatibilityTest {
  ...
  public static void main(final String[] args) throws Exception {
    ...
    final String stateDirStr =
        args.length > 1 ? args[1] : TestUtils.tempDirectory().getAbsolutePath();
    ...
    streamsProperties
        .put(StreamsConfig.APPLICATION_ID_CONFIG, "kafka-streams-system-test-broker-compatibility");
    ...
    streamsProperties
        .put(StreamsConfig.consumerPrefix(ConsumerConfig.SESSION_TIMEOUT_MS_CONFIG), timeout);
    streamsProperties
        .put(StreamsConfig.consumerPrefix(ConsumerConfig.FETCH_MAX_WAIT_MS_CONFIG), timeout);
    ...
    streams.setUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
      ...
      public void uncaughtException(final Thread t, final Throwable e) {
        System.out
            .println("FATAL: An unexpected exception is encountered on thread " + t + ": " + e);
